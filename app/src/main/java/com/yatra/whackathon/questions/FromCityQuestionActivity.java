...
public class FromCityQuestionActivity extends AppCompatActivity {

    final String TAG="FromCityQA";
    private final int FROM_CITY = 1;
    private final int YES_NO_QUESTION = 2;
    private final String introduction="We will help you in booking your flight tickets today? Enter your city name";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_city_question);
...
//            startActivityForResult(intent, code);
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    VoiceRecognitionActivity activity = new VoiceRecognitionActivity(FromCityQuestionActivity.this, new VoiceRecognitionActivity.VoiceRecognitionResponse() {
                        @Override
                                ...
                                case YES_NO_QUESTION: {
                                    if (null != result) {
                                        ...
                                        if (new String("yes").equalsIgnoreCase(text)) {
                                            authenticateCity(fromCity);

                                        } else if (new String("no").equalsIgnoreCase(text)) {
                                            Intent intent = new Intent(FromCityQuestionActivity.this, FromCityQuestionActivity.class);
                                            finish();
                                            startActivity(intent);
                                        } else {
...
//                                            startSpeechToText(YES_NO_QUESTION);
    ...
    public void authenticateCity(String city)
    {
        ...
        StringRequest myReq = new StringRequest( Request.Method.GET, "http://10.42.0.88:5000/fromcity/"+city.toLowerCase()
...
//                startActivity(intent);
                ...
                try {
                    ...
                    if (status.equalsIgnoreCase("true")) {
                        ...
                        String name = airport.getString("from_airportname");
                        ...
                        Log.d(TAG,response+"status false");
