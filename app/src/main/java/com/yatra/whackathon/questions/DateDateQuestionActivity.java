...
public class DateDateQuestionActivity extends AppCompatActivity {

    private final int DATE_DATE = 1;
    private final int YES_NO_QUESTION = 2;
    private final String introduction="On which date you want to fly? Enter date";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_date_date_question);
        ...
        nextQuestion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    //TODO:check city
                    Intent intent = new Intent(DateDateQuestionActivity.this, DateMonthQuestionActivity.class);
                    finish();
...
//            startActivityForResult(intent, code);
            runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    VoiceRecognitionActivity activity = new VoiceRecognitionActivity(DateDateQuestionActivity.this, new VoiceRecognitionActivity.VoiceRecognitionResponse() {
                        @Override
...
//                                        ArrayList<String> result = data.getStringArrayListExtra(RecognizerIntent.EXTRA_RESULTS);
                                        ...
                                        // TODO : Convert date to int
                                        String spelling = result;
//                                        for (int i = 0; i < fromCity.length(); i++) {
//                                            spelling = spelling + fromCity.charAt(i)+" ";
//                                        }
                                        String reply = "The date you said is " + Util.convert(date) + ". " + yesNoQuestion;
                                ...
                                case YES_NO_QUESTION: {
                                    if (null != result) {
                                        ...
                                        if (new String("yes").equalsIgnoreCase(text)) {
                                            ...
                                            Intent intent = new Intent(DateDateQuestionActivity.this, DateDateQuestionActivity.class);
                                            finish();
                                            startActivity(intent);
                                        } else {
